  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <div
          className={`px-3 py-1.5 rounded-xl text-xs font-semibold ${teacher.isActive ? "bg-green-100 text-green-700" : "bg-gray-100 text-gray-500"}`}
        >
              ...
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                <table className="w-full text-sm">
                    ...
                    {stats.byMonth.map((m) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-center">
                          <span
                            className={`font-semibold ${m.completed === m.total ? "text-green-600" : "text-amber-600"}`}
                          >
                            {m.completed}
                          </span>
                        </td>
                  ...
                  <tfoot className="border-t border-gray-200 bg-gray-50">
                    <tr>
                      <td className="px-5 py-3 text-xs font-semibold text-gray-500 uppercase">
                        Razem
                      </td>
                      ...
                      <td className="px-5 py-3 text-right font-bold text-indigo-700">
                        {stats.overall.hours.toFixed(1)} h
                      </td>
                    </tr>
                  </tfoot>
                </table>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <p className="font-bold text-indigo-600 text-lg">
                          {bg.hours.toFixed(1)} h
                        </p>
                        <p className="text-xs text-gray-400">
                          {bg.completed} z {bg.total} zajęć
                        </p>
                      </div>
                    </div>
