  ...
  return (
    <div className="min-h-screen flex bg-background">
      ...
      <main className="flex-1 overflow-auto">
        {/* `mode="wait"` — bez tego nowy widok montuje się, zanim stary zniknie,
            i przez moment renderują się dwie kopie strony (widoczne jako
            mignięcie zdublowanego nagłówka). */}
